...
def earthquake_csv_file(data_dump):
...
#exporting the information to a csv file
    with open("Earthquake_Data.csv", "a+", newline = "")as csvfile:
        writer = csv.writer(csvfile)
        writer.writerow(["Place", "Alert", "Felt", "Magnitude", "Tsunami"])
